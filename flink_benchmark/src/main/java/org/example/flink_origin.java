...
public class flink_origin {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("TPC-H Q3 - BasedProcessFunction Streaming Implementation");
        System.out.println("========================================================\n");
        ...
        System.out.println("Executing TPC-H Q3 with BasedProcessFunction...\n");
        ...
        System.out.println("- BasedProcessFunction for advanced monitoring and state management");
        ...
        System.out.println("- Window-based state management with configurable window length");
        System.out.println("- Performance metrics tracking (Store time, Output time)");
        System.out.println("- Batch reading with streaming-like processing");
        System.out.println("- Single thread execution (parallelism = 1)");
        System.out.println("\nStarting execution...\n");

        // 执行
        long executeStartTime = System.currentTimeMillis();
        env.execute("TPC-H Q3 - BasedProcessFunction Implementation");
        ...
        System.out.println("      BasedProcessFunction provides additional timing metrics stored in StoreAccur and OutputAccur.");
        System.out.println("========================================\n");
    }
}
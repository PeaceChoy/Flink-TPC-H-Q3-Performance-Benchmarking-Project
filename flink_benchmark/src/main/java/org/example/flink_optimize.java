...
public class flink_optimize {
    ...
    // 使用ProcessFunction进行流控制和监控 - 优化版本
    public static class StreamControlProcessFunction extends ProcessFunction<Row, Row> {
        ...
        public void open(Configuration parameters) throws Exception {
            ...
            System.out.println("[StreamControl] Initialized with rate limit: " + recordsPerSecond + " rec/sec");
        }
...
//    // 使用KeyedProcessFunction进行监控和统计 - 优化版本
...
//
//            System.out.println("[MonitoringProcess] Initialized");
//        }
//
//        @Override
//        public void processElement(Row value, Context ctx, Collector<Row> out) throws Exception {
...
//            // 更新计数
//            count = count + 1;
//            recordCountState.update(count);
//
//            // 输出原始记录
//            out.collect(value);
//
//            // 每个key的第1条记录打印详细信息，之后每1000条打印一次
//            if (count == 1 || count % 1000 == 0) {
//                Long orderKey = (Long) value.getField(0);
//                java.math.BigDecimal revenue = (java.math.BigDecimal) value.getField(1);
//                System.out.println(String.format(
//                        "[Key %d] Record #%d: revenue=%.2f",
//                        orderKey, count, revenue.doubleValue()
//                ));
//            }
//        }
//
...
//    }
    ...
    public static class MonitoringSink extends RichSinkFunction<Row> {
        ...
        public void invoke(Row value, Context context) throws Exception {
            ...
            if (count % 10000 == 0) {
                ...
                double rate = 10000.0 / (timeDiff / 1000.0);
                System.out.println(String.format(
                        "[Sink Progress] Records: %d, Rate: %.2f rec/sec",
                        count, rate
                ));
    ...
    public static void main(String[] args) throws Exception {
        ...
        tableEnv.getConfig().getConfiguration().setString("table.exec.mini-batch.allow-latency", "1s");
        ...
        // 先统计一下数据量
        System.out.println("Checking data statistics...");

        // TPC-H Q3查询 - 优化JOIN顺序和过滤条件，去掉LIMIT
        String q3Query =
        ...
        System.out.println("Query: " + q3Query + "\n");
        ...
        int rateLimit = 10000; // 每秒10000条，提高速率
...
//                .setParallelism(4);
        ...
        System.out.println("- Direct record output to ensure no data loss");
        System.out.println("\nStarting execution...\n");
